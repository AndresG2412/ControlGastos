    ...
    return (
        <div className='w-screen h-screen flex flex-col items-center justify-center'>
            ...
            <form onSubmit={verificar} className='w-1/3 bg-white/10 rounded-2xl p-10'>
                <p className='font-semibold text-3xl text-center tracking-wider'>Formulario Deuda</p>
                ...
                <div className='w-2/3 mx-auto'>
                    <button type='submit' className='border-white hover:duration-300 border-1 px-4 py-2 font-semibold tracking-wide text-lg rounded bg-green-400 hover:scale-110 hover:bg-green-600 w-full'>Agregar Deuda</button>
                </div>
            </form>
        </div>
    )
